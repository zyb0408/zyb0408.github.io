define(['jquery', 'Vue'], function($, Vue) {
    return ({
        template: `<div><div class="keyboard" ref="keybord"></div></div>`,
        data: function() {
            return {
                bb: 'bbbbbbbbb'
            }
        ...
        mounted() {
            ...
            $.fn.keyboard = function(a) {
                ...
                var a = $.extend({
                    ...
                    keyREffect: true,
                    keyREffectTimes: 3,
                    backgroundClolrContiner: 'rgba(0, 0, 0, 0.53)'
                }, a || {});
            ...
            function addEL(d, f) {
                ...
                function setBoardColor(n) {
                    ...
                    g.css({
                        ...
                        'background': s.backgroundClolrContiner
                    })
            ...
            // })(jQuery);
            // debugger
            $(this.$refs.keybord).keyboard({
                audio: 'music/keydown.mp3',
                ...
                keyBorderWidth: 2, //每个按钮的边线宽度
                keyBorderColor: '#fff', //每个按钮的边线颜色
                keyColorShadow: 0, //每个按钮的阴影扩散度
                ...
                keyColorsRun: false, //是否开启按钮颜色移动变化
                ...
                boardColorsRun: false, //是否开启键盘背景内阴影播放，不开启默认显示第一个颜色
                boardColorsRunType: 'random', //键盘内阴影播放方式'random' 随机播放 'order' 按顺序播放
                boardColorsInsetSize: 0, //键盘内阴影大小
                boardColorsRunTimes: 1500, //键盘内阴影播放频率(毫秒)
                keyAfterToRunTime: 8000, //按键结束后多少秒自动开启默认播放动作
                // audio: '', //按键声音路径
                keyREffect: false, //是否开启按键四射特效
                keyREffectTimes: 10 //按键特效速度，越小越快
            });
            // this.$refs.keybord.keyboard({ audio: 'music/keydown.mp3' });
        }
    })
});